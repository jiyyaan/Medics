              ...
              Padding(
                ...
                child: Obx(()=>PasswordField(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(
                      Get.find<SignupController>().showPassword.value ? Icons.visibility_off : Icons.visibility,
                    ),
                    onPressed: () {
                      Get.find<SignupController>().showPassword.value =! Get.find<SignupController>().showPassword.value;
                    },
                  ),
                ),),
              ),
